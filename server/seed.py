...
with app.app_context():
    ...
    pr1 = RestaurantPizza(restaurant_id=shack, pizza_id=cheese, price=1)
    pr2 = RestaurantPizza(restaurant_id=bistro, pizza_id=pepperoni, price=4)
    pr3 = RestaurantPizza(restaurant_id=palace, pizza_id=california, price=5)
